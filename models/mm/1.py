...
class FashionHybridModel(nn.Module):
    ...
    def __init__(self, num_categories: int = 50, num_category_types: int = 3, num_attributes: int = 50,
    ...
    def forward(self, image: torch.Tensor, heatmap: torch.Tensor, attributes: torch.Tensor,
        ...
        try:
            ...
            outputs = {
                ...
                'attribute_preds': attribute_preds,  # Use the correct variable
...
# At the bottom of fashion_cnn.py
__all__ = ['FashionHybridModel', 'FashionMultiTaskLoss', 'compute_f1_multilabel']