...
class FashionHybridModel(nn.Module):
    ...
    def __init__(self, num_categories=46, num_category_types=3, num_attributes=50, embed_dim=256, 
                 use_pretrained=True, dropout_rate=0.5, backbone='resnet50'):
        """
        Args:
    ...
    def freeze_backbone(self, freeze=True):
        """Freeze or unfreeze the image encoder backbone parameters"""
...
class FashionMultiTaskLoss(nn.Module):
    ...
    3. Binary cross-entropy loss for attribute prediction
