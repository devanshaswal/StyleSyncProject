...
def train_epoch(model, train_loader, criterion, optimizer, device, epoch):
    ...
    # Log loss components (optional)
    logger.info(f'Epoch: {epoch}, Loss Components: {avg_components}')
...
def main(args):
    ...
    optimizer = optim.Adam(model.parameters(), lr=args.learning_rate, weight_decay=1e-5)  # Added weight_decay
